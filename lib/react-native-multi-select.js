...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    styleIconComponent: PropTypes.shape({
      searchIcon: Text.propTypes.style,
      closeIcon: Text.propTypes.style,
      dropdownIcon: Text.propTypes.style,
      checkIcon: Text.propTypes.style,
    }),
    emptySearchContainerStyle: ViewPropTypes.style,
    emptySearchTextStyle: Text.propTypes.style,
  ...
  constructor(props) {
    ...
    this.state = {
      selector: false,
      searchTerm: '',
      focus: new Animated.Value(this.focusState(false)),
      focused: false,
    };
  }
  ...
  componentWillUpdate(_props, state) {
    ...
    if (focused ^ state.focused) {
      let toValue = this.focusState(state.focused);
      Animated
        .timing(focus, { toValue, duration: 225 })
        .start();
    }
  }
          ...
          >
            <Icon
              ...
              style={[
                ...
                styleIconComponent && styleIconComponent.closeIcon && styleIconComponent.closeIcon,
              ]}
            />
          </TouchableOpacity>
        </View>
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, styleRowList, styleIconComponent } = this.props;
    return (
      <TouchableOpacity
            ...
            {this._itemSelected(item) ? (
              <Icon
                ...
                style={[
                  ...
                  styleIconComponent && styleIconComponent.checkIcon && styleIconComponent.checkIcon
                ]}
              />
            ) : null}
          </View>
    ...
    if (renderItems.length) {
      ...
      itemList = (
        <View style={[
          ...
          emptySearchContainerStyle && emptySearchContainerStyle
        ]}>
          <Text
            style={[
              {
              ...
              fontFamily ? { fontFamily } : {},
              emptySearchTextStyle && emptySearchTextStyle
            ]}
          >
            No item to display.
          </Text>
  ...
  render() {
    ...
    const { searchTerm, selector, focus } = this.state;
    const borderWidth = focus.interpolate({
      inputRange: [0, 1],
      outputRange: [0.333, 2],
    });
    return (
          ...
          >
            ...
            >
              ...
              <TextInput
                ...
                onSubmitEditing={(e) => canAddItems && this._addItem(e)}
                ...
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    ...
                    style={[
                      ...
                      styleIconComponent && styleIconComponent.dropdownIcon && styleIconComponent.dropdownIcon
                    ]}
                  />
                </TouchableOpacity>
              )}
